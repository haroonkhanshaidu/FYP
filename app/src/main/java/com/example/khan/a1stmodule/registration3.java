            ...
            ref.putFile(filePath)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(registration3.this, "Uploaded", Toast.LENGTH_SHORT).show();
                            findViewById(R.id.chooseimg).setVisibility(View.VISIBLE);
                            finish();
                            startActivity(new Intent(getApplicationContext(),passenger_profile.class));
                            ((TextView) findViewById(R.id.chooseimg)).setText("change profile picture");
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            progressDialog.dismiss();
                            Toast.makeText(registration3.this, "Failed "+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
